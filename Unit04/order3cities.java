 ...
 * Date : 09/13/2024
 * Lab 4.1 order3cities
 */
import java.util.*;
public class order3cities {
 // chicago los angeles 
	public static void main(String[] args) {
		...
		String city3 = scanner.nextLine().toUpperCase();
		scanner.close();
		...
		System.out.println("3 cities in alphabetical order: " + city1 + " " + city2 + " " + city3);
